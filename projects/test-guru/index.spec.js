...
describe("Test Guru", function () {
  ...
  // nice work. Class is about to end, so if you need anything let me know.
  // don't forget to "os submit" when you finish, and have a great weekend, k?
  //ok
