(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(500, 240, 1, .5);
        platform.create(200, 340, .919, .5);
        platform.create(400, 460, .819, .5);
        platform.create(200, 560, .819, .5);
        platform.create(60, 240, .819, .5);
        platform.create(60, 0, .07, 8);
